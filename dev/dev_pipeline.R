...
qual <- val_pipeline(
  ...
  deps_recursive = TRUE,
  val_date = as.Date('2026-02-24'), #Sys.Date(),
...
val_dir <- "/data/shared/riskassessments//R_4.5.1/20260224"
qual_metadata <- readRDS(file.path(val_dir, "qual_evidence.rds"))
