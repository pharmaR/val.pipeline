...
```{r license, eval=!val.report::is_risk_error(d_riskmetric$license) && !is.null(d_riskmetric$license), results='asis'}
cat("## License", "\n")
...
```{r, eval=!val.report::is_risk_error(d_riskmetric[["r_cmd_check"]]) || !val.report::is_risk_error(d_riskmetric[["remote_checks"]]), results='asis'}
cat("## Code checks", "\n")

cat("Code checks for this package:", "\n")
```

```{r r_cmd_check, eval=!val.report::is_risk_error(d_riskmetric[["r_cmd_check"]]), results='asis'}
...
```{r remote_checks, eval=!val.report::is_risk_error(d_riskmetric[["remote_checks"]]), results='asis'}
cat("Remote checks: ", d_riskmetric[["remote_checks"]])
```


```{r covr_coverage, eval=!val.report::is_risk_error(d_riskmetric[["covr_coverage"]]), results='asis'}
cat("## Code coverage", "\n")
