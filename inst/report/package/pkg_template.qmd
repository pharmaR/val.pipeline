...
```{r r_cmd_check, eval=!riskreports::is_risk_error(d_riskmetric[["r_cmd_check"]])}
d_riskmetric[["r_cmd_check"]] |> as.list() |> unlist()
```



```{r remote_checks, eval=!riskreports::is_risk_error(d_riskmetric[["remote_checks"]])}
