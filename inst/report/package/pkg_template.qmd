...
simple_cards <- data.frame(
  "Downloads 1 year" = prettyNum(r_riskmetric$downloads_1yr, big.mark = ","),
  "Reverse dependencies" = prettyNum(r_riskmetric$reverse_dependencies, big.mark = ","),
...
cat("Code checks for this package are:", "\n")
```

```{r r_cmd_check, eval=!riskreports::is_risk_error(d_riskmetric[["r_cmd_check"]]), results='asis'}
r_cmd <- d_riskmetric[["r_cmd_check"]]
cat("R CMD check for this package: ", paste(stringr::str_to_title(names(r_cmd)), r_cmd, sep = " - "))
```



```{r remote_checks, eval=!riskreports::is_risk_error(d_riskmetric[["remote_checks"]]), results='asis'}
cat("Remote checks for this package: ", d_riskmetric[["remote_checks"]])
```


```{r covr_coverage, eval=!riskreports::is_risk_error(d_riskmetric[["covr_coverage"]]), results='asis'}
cat("## Code coverage", "\n")

cat("Code coverage for this package is: ", d_riskmetric[["covr_coverage"]])
```
